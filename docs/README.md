...
force deletes only the existing rst files that were generated by this command to update with the new documentation in the statistical_clear_sky directory

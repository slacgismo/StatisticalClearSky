...
setup(
    ...
    name='StatisticalClearSky',  # Required
    ...
    # above.
    author_email='bennetm@stanford.edu',  # Optional
    ...
    #
    packages=find_packages(exclude=['contrib', 'docs', 'tests', 'clearsky', 'dataviewer', 'notebooks']),  # Required
    ...
    install_requires=['numpy', 'pandas', 'seaborn', 'cvxpy'],  # Optional

...
setup(
    ...
    #
    packages=find_packages(exclude=['contrib', 'docs', 'clearsky', 'dataviewer', 'notebooks']),  # Required
    ...
    install_requires=['numpy>=1.16', 'pandas', 'seaborn', 'cvxpy>=1.0'],  # Optional
